      ...
      <div className='row'>
        <div className='col-6 mt-5'>
          ...
          <div className='mt-5 flex'>
            <a style={{marginRight: '50px', fontSize: '20px'}} href="">Explore our products<i style={{marginLeft: '5px', fontSize: '20px'}} class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
            <a style={{marginRight: '50px', fontSize: '20px'}} href="">Try Kite Demo<i style={{marginLeft: '5px', fontSize: '20px'}} class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
          </div>
        </div>
        ...
        <img style={{width: '70%', marginLeft: '50px'}} src="media/images/press-logos.png" alt="press image" />
      </div>
    </div>
  )
}
